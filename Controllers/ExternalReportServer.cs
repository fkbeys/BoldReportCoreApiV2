    ...
    public sealed class ExternalServer : ReportingServer
    {
        ...
        public override bool CreateReport(string reportName, string folderName, byte[] reportdata, out string exception)
        {
            try
            {
                ...
                string dataSourcePath = targetFolder + reportName + ".rdl";

                dataSourcePath = dataSourcePath.Replace(".rdl.rdl", ".rdl");


                using var stream = File.Create(dataSourcePath);
        ...
        public override System.IO.Stream GetReport()
        {
            try
            {
                ...
                {
                    Log.Error("ExternalReportServer/GetReport da file not found"+reportPath!=null?reportPath:"");
                }
        ...
        {
            return base.CreateItem(itemType, itemName, folderName, Overwrite, itemData, out exception);
